...
for Hotel_Id,Providerx in zip(GoalID_list,Provider_list):
    ...
    df2 = percentile_list.replace('\n',' ', regex=True)
    df2.to_csv(filenamexyz,sep='|')
    ...
    commandy="s3cmd put --recursive --force /tmp/Content_scripts/"+filenamexyz+" "+"s3://qubole-poc-new-markets/content_integration/Content_Integration_Responses/External_table/Description/"
