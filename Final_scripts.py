...
command_x7="cd /tmp/Content_scripts/; python Content_Integration_Decs_Stage_Two.py "+sys.argv[1]
command_x8="cd /tmp/Content_scripts/; python Content_Integration_Stage_Two.py "+sys.argv[1]
